  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        These Terms of Service govern your use of our website located at lala.com (together or individually “Service”) operated by Nova VideoPlayer App.\n
        ...
        4. ContentContent found on or through this Service are the property of Nova VideoPlayer App or used with permission. You may not distribute, modify, transmit, reuse, download, repost, copy, or use said Content, whether in whole or in part, for commercial purposes or for personal gain, without express advance written permission from us.
        ...
        Service and its original content (excluding Content provided by users), features and functionality are and will remain the exclusive property of Nova VideoPlayer App and its licensors. Service is protected by copyright, trademark, and other laws of  and foreign countries. Our trademarks may not be used in connection with any product or service without the prior written consent of lie App.
        ...
        Our Service may contain links to third party web sites or services that are not owned or controlled by Nova VideoPlayer App.
        Nova VideoPlayer App has no control over, and assumes no responsibility for the content, privacy policies, or practices of any third party web sites or services. We do not warrant the offerings of any of these entities/individuals or their websites.
