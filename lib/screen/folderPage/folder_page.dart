...
import 'package:nova_videoplayer/screen/folderPage/widgets/folder_page_gridview.dart';
import 'package:nova_videoplayer/screen/folderPage/widgets/folder_page_listview.dart';
        ...
        body: Consumer<VideoDataModel>(
          builder: (context, value, child) {
            return Column(
              children: [
                const HeaderLogo(),
                value.allVideosList.isEmpty
                    ? const Center(
                        child: Text("No data to load"),
                      )
                    : Expanded(
                        child: !value.isGridView
                            ? const FolderPageListView()
                            : const FolderPageGridView(),
                      )
              ],
            );
          },
